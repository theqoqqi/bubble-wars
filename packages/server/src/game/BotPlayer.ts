...
export class BotPlayer {
  ...
  public updateAI(allTanks: ServerTank[], physics: PhysicsWorld, dt: number): PlayerInput {
    ...
    if (target) {
      ...
      const projSpeed = GAME_CONFIG.PROJECTILE.SPEED * (1000 / GAME_CONFIG.TICK_INTERVAL_MS) * 0.035;
      ...
      this.aimTarget = Math.atan2(arenaH / 2 - this.tank.body.position.y, arenaW / 2 - this.tank.body.position.x);
